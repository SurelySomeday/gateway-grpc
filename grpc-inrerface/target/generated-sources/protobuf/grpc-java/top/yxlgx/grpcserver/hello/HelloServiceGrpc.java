...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "top.yxlgx.grpcserver.hello.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<top.yxlgx.grpcserver.hello.HelloRequest,
      top.yxlgx.grpcserver.hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = top.yxlgx.grpcserver.hello.HelloRequest.class,
      responseType = top.yxlgx.grpcserver.hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<top.yxlgx.grpcserver.hello.HelloRequest,
      top.yxlgx.grpcserver.hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<top.yxlgx.grpcserver.hello.HelloRequest, top.yxlgx.grpcserver.hello.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<top.yxlgx.grpcserver.hello.HelloRequest, top.yxlgx.grpcserver.hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.yxlgx.grpcserver.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.yxlgx.grpcserver.hello.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(top.yxlgx.grpcserver.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<top.yxlgx.grpcserver.hello.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                top.yxlgx.grpcserver.hello.HelloRequest,
                top.yxlgx.grpcserver.hello.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public top.yxlgx.grpcserver.hello.HelloResponse hello(top.yxlgx.grpcserver.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<top.yxlgx.grpcserver.hello.HelloResponse> hello(
        top.yxlgx.grpcserver.hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((top.yxlgx.grpcserver.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<top.yxlgx.grpcserver.hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return top.yxlgx.grpcserver.hello.Hello.getDescriptor();
    }
